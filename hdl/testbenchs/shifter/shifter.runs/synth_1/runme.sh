...
HD_PWD='C:/Users/rebec/Desktop/Spacelab/brave/walker/testbenchs/shifter/shifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shifter_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shifter_tb.tcl
