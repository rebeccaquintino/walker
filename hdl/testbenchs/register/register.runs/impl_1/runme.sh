...
HD_PWD='C:/Users/rebec/Desktop/Spacelab/brave/walker/testbenchs/register/register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_tb.tcl -notrace
