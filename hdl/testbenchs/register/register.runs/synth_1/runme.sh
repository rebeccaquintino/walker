...
HD_PWD='C:/Users/rebec/Desktop/Spacelab/brave/walker/testbenchs/register/register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_tb.tcl
