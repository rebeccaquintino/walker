...
HD_PWD='C:/Users/rebec/Desktop/Spacelab/brave/walker/testbenchs/comparator/comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comparator_tb.tcl
