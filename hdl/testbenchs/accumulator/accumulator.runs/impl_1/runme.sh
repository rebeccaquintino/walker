...
HD_PWD='C:/Users/rebec/Desktop/Spacelab/brave/walker/testbenchs/accumulator/accumulator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log accumulator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source accumulator.tcl -notrace
